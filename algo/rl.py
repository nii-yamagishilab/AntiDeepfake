...
def grpo_loss_legacy(logits, logits_ref, sa_labels, gt_labels, rl_config):
    """
    ...
    """
    assert 1==0, "Wrong implementation of GRPO. Should not use this API"
    # sample num
...
def grpo3_degraded_ref(logits, logits_ref, logits_old, sa_labels, gt_labels, rl_config):
    """compute grpo loss for classifier
    
    For abalation study, turn this into a SFT like
    ...
    # following the https://huggingface.co/docs/trl/main/en/grpo_trainer
    # and https://github.com/lsdefine/simple_GRPO/blob/main/simple_grpo_v1/grpo_ref_split.py#L189
    reward = (r_ * reward  - kl_beta * kl).mean()
